        ...
        \begin{tiny}
          ...
          \begin{tabular}[t]{|@{\hskip1pt}p{6.9cm}|}
            ...
            \begin{tabular}[t]{|@{\hskip1pt}p{6.9cm}|}
              ...
              \footnotesize{information quantity} \\ \form{I(x_k) = -log_2(P(x_k))[bit]} \\ 
              \footnotesize{Entropy} \\ \(\text{Probability} * \text{information content}\) \\ \form{H(X) = \Sigma^N_{k=1} P(x_k) * I(x_k) [\dfrac{bit}{symbol}] } \\ where X is the list of symbols
              ...
              \footnotesize{Entropy without memory} \\ \form{H(H,Y) = \Sigma^N_{x_k} \Sigma^N_{y_i} P(x_k,y_i)*(-log_2(P(x_k,y_i))} \\
