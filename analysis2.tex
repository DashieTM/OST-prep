...
\begin{document}
    \begin{table}[ht!]
        \begin{tiny}
          \begin{tabular}{ccc}
          \begin{tabular}[t]{|@{\hskip1pt}p{9cm}|}
              \hline
              \mc{\footnotsize{Derivation Rules} \\
              ...
              \dx{(e^x) = e^x}\\\\
              \dx{(a^x) = ln(a) * a^x \text{ because: } e^{x * ln(a)} = a^x }\\\\
              \dx{(ln(x)) = \frac{1}{x}}\\\\
              ...
              \hline
              \mc{\footnotsize{All of these derive from:} \\
            ...
            \end{tabular}
            \hspace{-0.07in}
            \begin{tabular}[t]{|@{\hskip1pt}p{11.90cm}|}
              \hline
              \mc{}\\
              \hline
            \end{tabular}
