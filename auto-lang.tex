        ...
        \begin{normalsize}
          \begin{tabular}{ccc}
            ...
            \begin{tabular}[t]{|@{\hskip1pt}p{10.45cm}|}
              ...
              \footnotesize{This problem can be converted to another problem,ex. to the timetable problem:}\\
              \begin{tabular}{cc}
        ...
        \begin{normalsize}
          \begin{tabular}{ccc}
            \begin{tabular}[t]{|@{\hskip1pt}p{10.45cm}|}
              ...
              \hline
              \mc{\r{Complexity Class BPP}\\
              -- \blu{PTM} = NTM with random possibility chosen\\
              -- \r{results not always accurate!}\\
              -- Algorithm to calculate error probability is polynomial!\\
              \, \,\, Then used to determine if result is "good enough"\\
              -- encompasses all Problems that can be solved in polynomial time\\
              \, \,\, by a PTM.\\
              -- \(P \subset BPP\)\\
            ...
            \begin{tabular}[t]{|@{\hskip1pt}p{10.45cm}|}
              ...
              -- \r{Halting problem still not computable !!!}\\
              }\\
              \hline
              \mc{\r{Quantum-SAT}\\
              \footnotesize{Given a formula that takes in 2 inputs, for which half of it}\\
              \footnotesize{is constant, and the other half true.}\\
              \pic{220619-33}\\
              \pic{220619-34}\\
              }\\
              \hline
              \mc{\r{Complexity Class BQP}\\
              \pic{220619-35}\\
              \r{Quantum Computers need thousands of QBits to be useful}\\
              \r{right now, best we can do is around 100....}\\
              \r{"don't hold your breath for quantum pcs :)"}
              }\\
              \hline
            \end{tabular}
          \end{tabular}
