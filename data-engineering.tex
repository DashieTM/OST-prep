        ...
        \begin{tiny}
          \begin{tabular}{lll}
            \begin{tabular}[t]{|l|}
              ...
              >> data-manipulation language SQL 2003,\\ sql Explain, Xquery XML \\ >> \b{OLAP} | >> no secondary indexes (only automatic ones) \\ >> \b{ACID with Optimistic Concurrency Control -> OCC} \\ 
              ...
              \hl
              \mc{\b{execution models:} \\ >> \b{volcano execution model:} row by row -> ex:psql \\ \b{vectorized execution model:} value by value -> ex:MonetDB}\\
              \hl
              ...
              >> \b{Query and Data manipulation language (DML)} \\ >> \b{Data-Type-System (DDL)} \\ >> \b{supported by all big databases (psql)} \\ >> \b{results represent JSON docs but uses edges and nodes}}\\
              \hl
            ...
            \begin{tabular}[t]{|l|}
              ...
              \hl
              \mc{\b{execute statements} \\ \pic{220609-18} \\ !!this is the base, we always need to call this!! }\\
              \hl
